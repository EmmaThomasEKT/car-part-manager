...
public class MainMenu {
    ...
    public static boolean myCar(Scanner scanner) {

    }

    public static boolean selectCarParts(Scanner scanner) {

    }

    public static boolean calculateBudget(Scanner scanner) {

    }

    public static boolean information(Scanner scanner) {
